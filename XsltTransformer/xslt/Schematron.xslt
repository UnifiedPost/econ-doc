...
<xsl:transform xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
	...
	<rdf:Description xmlns:dc="http://purl.org/dc/elements/1.1/"
		...
		<dct:created>2023-12-20T10:39:35.391+02:00</dct:created>
	</rdf:Description>
	...
	<xsl:template match="root()">
		...
		<xsl:variable name="report" as="element(schxslt:report)">
			<schxslt:report>
				<xsl:call-template name="d13e162"/>
			</schxslt:report>
		</xsl:variable>
	...
	<xsl:template name="d13e162">
		<schxslt:document>
			...
			<xsl:apply-templates mode="d13e162" select="root()"/>
		</schxslt:document>
	</xsl:template>
	...
	<xsl:template match="ubl-creditnote:CreditNote" priority="78" mode="d13e162">
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
	...
	<xsl:template match="cbc:TaxCurrencyCode" priority="76" mode="d13e162">
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e183']">
				<schxslt:rule pattern="d13e183">
	...
	<xsl:template match="cac:Price/cac:AllowanceCharge" priority="65" mode="d13e162">
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e183']">
				<schxslt:rule pattern="d13e183">
	...
	<xsl:template match="cac:AccountingSupplierParty/cac:Party[$supplierCountry = 'NO']"
		...
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e415']">
				<schxslt:rule pattern="d13e415">
			...
			<xsl:otherwise>
				...
				<xsl:next-match>
					<xsl:with-param name="schxslt:patterns-matched"
									 as="xs:string*"
									 select="($schxslt:patterns-matched, 'd13e415')"/>
				</xsl:next-match>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	<xsl:template match="ubl-creditnote:CreditNote[$DKSupplierCountry = 'DK'] | ubl-invoice:Invoice[$DKSupplierCountry = 'DK']"
		...
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e431']">
				<schxslt:rule pattern="d13e431">
			...
			<xsl:otherwise>
				...
				<xsl:next-match>
					<xsl:with-param name="schxslt:patterns-matched"
									 as="xs:string*"
									 select="($schxslt:patterns-matched, 'd13e431')"/>
				</xsl:next-match>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="//cac:AccountingSupplierParty/cac:Party[cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'SE' and cac:PartyTaxScheme[cac:TaxScheme/cbc:ID = 'VAT']/substring(cbc:CompanyID, 1, 2) = 'SE']"
		...
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e526']">
				<schxslt:rule pattern="d13e526">
			...
			<xsl:otherwise>
				...
				<xsl:next-match>
					<xsl:with-param name="schxslt:patterns-matched"
									 as="xs:string*"
									 select="($schxslt:patterns-matched, 'd13e526')"/>
				</xsl:next-match>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="/ubl-invoice:Invoice/cbc:ID[$isGreekSender] | /ubl-creditnote:CreditNote/cbc:ID[$isGreekSender]"
		...
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e607']">
				<schxslt:rule pattern="d13e607">
			...
			<xsl:otherwise>
				...
				<xsl:next-match>
					<xsl:with-param name="schxslt:patterns-matched"
									 as="xs:string*"
									 select="($schxslt:patterns-matched, 'd13e607')"/>
				</xsl:next-match>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="ubl-creditnote:CreditNote[$SupplierCountry = 'IS'] | ubl-invoice:Invoice[$SupplierCountry = 'IS']"
		...
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e743']">
				<schxslt:rule pattern="d13e743">
			...
			<xsl:otherwise>
				...
				<xsl:next-match>
					<xsl:with-param name="schxslt:patterns-matched"
									 as="xs:string*"
									 select="($schxslt:patterns-matched, 'd13e743')"/>
				</xsl:next-match>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="cbc:InvoiceTypeCode" priority="11" mode="d13e162">
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e875']">
				<schxslt:rule pattern="d13e875">
	...
	<xsl:template match="cbc:CreditNoteTypeCode" priority="10" mode="d13e162">
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e875']">
				<schxslt:rule pattern="d13e875">
	...
	<xsl:template match="cbc:EndpointID[@schemeID]" priority="8" mode="d13e162">
		<xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
		<xsl:choose>
			<xsl:when test="$schxslt:patterns-matched[. = 'd13e875']">
				<schxslt:rule pattern="d13e875">
